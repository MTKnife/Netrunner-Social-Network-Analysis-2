...
factionVector <- c("haas-bioroid", "nbn", "the-weyland-consortium", "jinteki")
...
if (file.exists("CorpURLList.txt")) {
  file.remove("CorpURLList.txt")}
# Write the list of URL's to a file.
write(deckURLList, file = "CorpURLList.txt")
